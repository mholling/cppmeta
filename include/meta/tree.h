...
namespace CppMeta {
  ...
  template <typename T> using IsTree = Eval<IsTreeImpl<T>>;
  ...
  template <typename Tree> using IsLeaf = Eval<IsLeafImpl<Tree>>;
  
  template <typename Tree> struct RootImpl;
  template <typename Node, typename... Branches>
  struct RootImpl<Tree<Node, Branches...>> { using Result = Node; };
  template <typename Tree> using Root = Eval<RootImpl<Tree>>;
  
  template <typename Tree, typename Type> struct ContainsImpl;
  template <typename Tree, typename Type> using Contains = Eval<ContainsImpl<Tree, Type>>;
  ...
  template <typename Tree, typename Type> using FindBranch = Eval<FindBranchImpl<Tree, Type>>;
  template <typename Type, typename Node, typename... Branches>
  ...
  template <typename Tree, typename Type> using Children = Eval<ChildrenImpl<Tree, Type>>;
  template <typename Type, typename Node, typename... Branches>
  ...
  template <typename Tree, typename Type, typename IncludeSelf> using Lineage = Eval<LineageImpl<Tree, Type, IncludeSelf>>;
  ...
  template <typename Tree, typename Type1, typename Type2> using CommonBranch = Eval<CommonBranchImpl<Tree, Type1, Type2>>;
  ...
  template <typename Tree> using Flatten = Eval<FlattenImpl<Tree>>;
  template <typename Node, typename... Branches>
  ...
  template <typename Tree, typename Type> using Index = Eval<IndexImpl<Tree, Type>>;
  template <typename Type, typename Node, typename... Branches>
  ...
  template <typename Tree> using Leaves = Eval<LeavesImpl<Tree>>;
  template <typename Node, typename... Branches>
  ...
  template <typename Tree, template <typename> class Predicate> using Find = Eval<FindImpl<Tree, Predicate>>;
  ...
  template <typename Tree> using Height = Eval<HeightImpl<Tree>>;
  template <typename Node, typename... Branches>
  ...
  template <typename Tree, typename Type1, typename Type2> using Distance = Eval<DistanceImpl<Tree, Type1, Type2>>;
  
  template <typename Tree, typename Type> struct AppendImpl;
  template <typename Tree, typename Type> using Append = Eval<AppendImpl<Tree, Type>>;
  ...
  template <typename Tree, typename Type> using Prepend = Eval<PrependImpl<Tree, Type>>;
  template <typename Node, typename... Branches, typename Type>
