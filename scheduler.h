namespace Scheduler {
  ...
  typename Queue<Machine>::NodeType Queue<Machine>::Dispatch<Event>::dispatch = Dispatcher<Machine, Event>::dispatch;
  ...
  struct Post {
    template <typename Machine> using RespondsToEvent = RespondsTo<Machine, Event>;
